    ...
    <div class="col-sm-12">
        <div class="tab-pane active" id="description_tab">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <?php
                    echo form_dropdown('cat[parent_id]', $categories, $cat->parent_id,  'class="form-control form-category"');
                    ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    ...
                    echo form_dropdown('cat[status]', $st, $cat->status, 'class="form-control"');
                    ?>
                </div>
