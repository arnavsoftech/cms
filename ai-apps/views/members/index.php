...
<div class="widget">
    <div class="widget-head">
        <i class="fa fa-pencil"></i> Latest Properties
    </div>
    <table class="table table-bordered table-striped">
        ...
        foreach($mem_list as $m){
            ...
            <tr>
                ...
                <td><?= AI_User::typStr($m -> user_type); ?></td>
                ...
                <td>
                    <div class="pull-right btn-group">
                        <a href="<?php echo admin_url('members/add/'.$m -> id); ?>" class="btn btn-default btn-sm"><i class="fa fa-pencil"></i> </a><a href="<?php echo admin_url('members/delete/'.$m -> id); ?>" class="btn btn-danger btn-sm delete"><i class="fa fa-trash"></i> </a>
                    </div>
                </td>
            </tr>
        <?php
