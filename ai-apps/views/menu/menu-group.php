...
<div class="widget">
                ...
                <tr>
                    <td colspan="2">
                        <div class="panel-group" id="accordion">
                                ...
                                <div class="box">
                                    <div class="box-header clearfix">
                                        ...
                                        <div class="btn-group pull-right">
                                            <a class="btn btn-xs btn-default" href="<?php echo admin_url('menu/addlink/' . $row['id']); ?>" title="Add Link"><i class="fa fa-plus-circle"></i> Add New</a>
                                            <a class="btn btn-xs btn-info" href="<?php echo admin_url('menu/group/' . $row['id']); ?>" title="Edit Menu"><i class="fa fa-pencil"></i></a>
                                            <a class="btn btn-xs btn-danger delete" href="<?php echo admin_url('menu/delgroup/' . $row['id']); ?>" title="Delete Menu"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </div>
                            ...
                            <?php endforeach; ?>
                            <?php
                            function list_menus($cats, $rowid, $scats = '')
                            {
                                if (count($cats) > 0) {
                                    foreach ($cats as $r) {
                            ?>
    ...
    <?php
                                        if (count($r['children']) > 0) {
                                            list_menus($r['children'], $rowid, $scats . $r['menu_title'] . '&rarr; ');
                                        }
                                    }
                                }
                            }
