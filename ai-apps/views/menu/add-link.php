...
<?php echo form_open(admin_url('menu/addlink/' . $group_id), array('class' => 'form-horizontal')); ?>
<div class="tabbable">
    ...
    <div class="form-group">
        ...
        <div id="parent_id" class="col-sm-2">
            <select name="menu_parent" class="form-control input-sm select2">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <label class="radio-inline">
                <input type="radio" name="link_type" value="4" data-type="postdd" class="option" />Posts
            </label>
            ...
            <div id="categorydd" class="linktype">
                ...
                <?php echo form_dropdown('category_dd', $category_dd, 0, 'class="linkdd form-control input-sm select2"'); ?>
            </div>
            <div id="pagedd" class="linktype">
                <?php $page_dd[0] = 'Select'; ?>
                <?php echo form_dropdown('page_dd', $page_dd, 0, 'class="linkdd form-control input-sm select2"'); ?>
            </div>
            <div id="postdd" class="linktype">
                <?php
                $post_dd[0] = 'Select';
                echo form_dropdown('post_dd', $post_dd, 0, 'class="linkdd form-control input-sm select2"');
                ?>
            </div>
        </div>
    </div>
