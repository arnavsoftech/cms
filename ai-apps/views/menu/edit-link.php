...
<?php echo form_open(admin_url('menu/editlink/' . $menu['id']), array('class' => 'form-horizontal')); ?>
<div class="tabbable">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            ...
            <label class="radio-inline">
                <input type="radio" name="link_type" value="4" data-type="postdd" class="option" <?php if ($menu['link_type'] == 4) echo 'checked'; ?> />Posts
            </label>
            ...
            <div id="categorydd" class="linktype <?php if ($menu['link_type'] == 2) echo 'active'; ?>">
                ...
                <?php echo form_dropdown('category_dd', $category_dd, $menu['menu_url'], 'class="linkdd form-control input-sm select2"'); ?>
            </div>
            <div id="pagedd" class="linktype <?php if ($menu['link_type'] == 3) echo 'active'; ?>">
                <?php $page_dd[0] = 'Select'; ?>
                <?php echo form_dropdown('page_dd', $page_dd, $menu['menu_url'], 'class="linkdd form-control input-sm select2"'); ?>
            </div>
            <div id="postdd" class="linktype <?php if ($menu['link_type'] == 4) echo 'active'; ?>">
                <?php
                $post_dd[0] = 'Select';
                echo form_dropdown('post_dd', $post_dd, $menu['menu_url'], 'class="linkdd form-control input-sm select2"');
                ?>
            </div>
        </div>
    </div>
