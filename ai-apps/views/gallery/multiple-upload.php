    ...
    <div class="form-group">
        ...
        <div class="form-group">
        	<div class="col-lg-4 col-lg-offset-2">
                ...
                <button type="submit" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-floppy-disk"></i> Upload</button>
                <a href="<?php echo site_url($this -> config -> item('admin').'gallery'); ?>" class="btn btn-default btn-sm">Cancel</a>
            </div>
        </div>
    	</form>